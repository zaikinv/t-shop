...
.container-teaser.svelte-rcfg61.svelte-rcfg61{display:grid;grid-auto-columns:1fr;grid-auto-rows:1fr;grid-auto-flow:column;gap:60px;padding:2rem 0}@media(max-width: 960px){.container-teaser.svelte-rcfg61.svelte-rcfg61{grid-template-rows:repeat(2, auto);grid-template-columns:1fr}}.container-teaser.svelte-rcfg61 img.svelte-rcfg61{width:100%}.container-teaser__button.svelte-rcfg61.svelte-rcfg61{all:unset;border:1px solid black;padding:0.5rem 1rem;cursor:pointer;align-items:center;display:flex;flex-direction:row;justify-content:center;margin-top:3rem}.container-teaser__title.svelte-rcfg61.svelte-rcfg61{margin-top:0;text-align:left}.container-teaser__description.svelte-rcfg61.svelte-rcfg61{margin-top:0;text-align:left}`),
      ),
...
function instance($$self) {
  const handleClick = (event) => {
    ...
    document.dispatchEvent(
      new CustomEvent('select-random', { bubbles: true, composed: true }),
    );
  };
  return [handleClick];
}
