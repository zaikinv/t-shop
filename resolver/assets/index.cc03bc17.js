...
class p extends h {
  ...
  firstUpdated(m) {
    const t = +this.scale, i = `${252 * t}px`, o = `${300 * t}px`, n = 75 * t, r = 75 * t, a = `${87 * t}px`, c = `${65 * t}px`;
    ...
    e.addEventListener(
      "load",
      function() {
        s.height = n, s.width = r, d.drawImage(e, 0, 0);
      },
      !1
    ), e.src = `${this.url}&auto=format&fit=crop&w=${n}&h=${r}`;
  }
  constructor() {
    super();
  }
