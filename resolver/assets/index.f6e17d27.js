...
class p extends d {
  ...
  update() {
    const t = this.scale ? +this.scale : 1, i = `${252 * t}px`, o = `${300 * t}px`, n = Math.floor(75 * t), a = Math.floor(75 * t), c = `${87 * t}px`, r = `${65 * t}px`;
    ...
    e.addEventListener(
      "load",
      function() {
        s.height = n, s.width = a, h.drawImage(e, 0, 0);
      },
      !1
    ), e.src = `https://loremflickr.com/${n}/${a}/${this.category}?lock=${this.id}`;
  }
  constructor() {
    super();
  }
